...
public class UiPerspective implements IPerspectiveFactory
{
	...
	public void createInitialLayout(IPageLayout layout)
	{
		...
		IFolderLayout rightFolder=layout.createFolder("rightFolder", IPageLayout.RIGHT, 0.75f, id);
		rightFolder.addView(IPageLayout.ID_OUTLINE);
		
		IFolderLayout bottomFolder=layout.createFolder("bottomFolder", IPageLayout.BOTTOM, 0.75f, id);
